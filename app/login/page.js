    ...
    <>
      <div className="text-white">
        <h1 className="text-2xl font-bold text-center my-10">
          Login/Sign Up to get your fans to support you
        </h1>
      </div>

      <div className="text-white">
        <div class="flex flex-col gap-2 min-h-screen items-center">
          <button class="flex items-center bg-white border w-64  border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
              class="h-6 w-6 mr-2"
          ...
          <button onClick={()=>{signIn("github")}} class="flex items-center bg-white border w-64  border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
            <svg
              class="h-6 w-6 mr-2"
              xmlns="http://www.w3.org/2000/svg"
              xmlnsXlink="http://www.w3.org/1999/xlink"
